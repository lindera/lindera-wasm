...
// execSync('NODE_OPTIONS="--max-old-space-size=4096 --experimental-wasm-modules" npx vite build', { stdio: 'inherit' });
execSync('NODE_OPTIONS="--max-old-space-size=8192 --experimental-wasm-modules" npx vite build', { stdio: 'inherit' });
